                ...
                <div class="panel-body">
                    <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <textarea name="product_desc" id="" cols="6" rows="19"></textarea>
                        </div>
                        <div class="form-group">
...
if(isset($_POST['submit'])){
    ...
    ('$product_cat','$cat',NOW(),'$product_title','$product_img1','$product_img2','$product_img3','$product_price','$product_desc','$product_keyword')";
